    ...
    <ul class="nav navbar-nav navbar-right mr-auto mt-2 mt-lg-0">
      ...
      @if($pembeli)
        ...
        <div class="dropdown">
          ...
          @php
            $avatar_image = isset($pembeli->origin_image) ? $pembeli->origin_image : 'default-avatar.jpg';
          @endphp
          <img src="{{ asset('images/'.$avatar_image)}}" alt="Avatar" class="avatar" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
